    ...
    <div className="flex flex-col md:flex-row h-screen w-full mx-auto bg-white p-2">
      ...
      <div className="flex flex-col items-center md:w-1/3">
        ...
        <div className="flex justify-center mt-auto mb-8">
          {isEditing ? (
            <button onClick={handleSave} className="bg-orange-500 text-white px-3 py-3 rounded-lg w-48 transition-colors hover:bg-blue-400">Save</button>
          ) : (
            <button onClick={() => setIsEditing(true)} className="bg-orange-500 text-white px-3 py-3 rounded-lg w-48 transition-colors hover:bg-blue-400">Edit Profile</button>
          )}
        </div>
      </div>
