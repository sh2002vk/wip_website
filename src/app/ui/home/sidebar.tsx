    ...
    <div className="flex flex-col h-screen w-20 md:w-64 bg-white-200 border-r border-black">
      ...
      <div className="flex flex-col flex-grow">
        <nav className="flex flex-col mt-10 space-y-2">
          ...
          <Link href="/home/dashboard" className="group flex items-center pl-10 pr-4 h-12 w-full hover:bg-gray-300">
          ...
          <Link href="/home/manage" className="group flex items-center pl-10 pr-4 h-12 w-full hover:bg-gray-300">
